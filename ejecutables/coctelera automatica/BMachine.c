...
struct inventario datos[10]=                        // Inventario Inicial de Bebidas
{
10,"Coca Cola",3,
10,"Pepsi Cola",3,
10,"Jugo de Mora",6,
...
{
  system("cls");   
  printf("\n  MM    MM                         iii                   MM    MM  HH   HH ");
  printf("\n  MMM  MMM   aa aa   qqqqq uu   uu     nn nnn    aa aa   MMM  MMM  HH   HH ");
  printf("\n  MM MM MM  aa aaa qq   qq uu   uu iii nnn  nn  aa aaa   MM MM MM  HHHHHHH ");
  printf("\n  MM    MM aa  aaa  qqqqqq uu   uu iii nn   nn aa  aaa   MM    MM  HH   HH ");
  printf("\n  MM    MM  aaa aa      qq  uuuu u iii nn   nn  aaa aa   MM    MM  HH   HH \n\n");
  printf("\t1) Sacar un Bebida\n");
  printf("\t2) Reponer Bebida\n");
  ...
  switch (opcion)
  {
   case 1: refresco();                              // Compro Refrescos
           break;
   case 2: reponer_retirar(1);                      // Repongo Refrescos
           break;
   case 3: invent_val_din(1);                       // Imprimo el Inventario de Bebidas
           break;
...
{     
  ...
  scanf("%i",&item);                                // Capturo la Bebida a Comprar 
  if (item<1||item>10)
